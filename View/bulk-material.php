    ...
    <h3 style="text-align: center;">Bulk and Liquid Material</h3>
        <div class="row1">
            ...
            <h2>Liquid</h2>
                <form>
                    <div class="form-group">
                        <label for="drill_mud">Drilling Mud, Volume</label>
